...
intro:
  - excerpt: 'Support the development &nbsp; [<i class="fa fa-heart" aria-hidden="true"></i> Donate Patreon](https://www.patreon.com/diskover){: .btn .btn--primary} [<i class="fa fa-paypal" aria-hidden="true"></i> Donate PayPal](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=CLF223XAS4W72){: .btn .btn--primary}'
---
