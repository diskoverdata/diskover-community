...
header:
  ...
  caption:
excerpt: '<img src="https://github.com/shirosaidev/diskover/raw/master/docs/diskover.png?raw=true" style="width: 183px; float: left; margin: 0px 10px 10px 0px;">File system crawler and storage analytics software that uses Elasticsearch to help visualize and manage your disk space usage.<br /> <small><a href="https://github.com/shirosaidev/diskover/releases/tag/v1.4.4">Latest release v1.4.4</a></small><br /><br />
...
intro:
  - excerpt: 'Support the development &nbsp; [<i class="fa fa-heart" aria-hidden="true"></i> Donate Patreon](https://www.patreon.com/diskover){: .btn .btn--primary} [<i class="fa fa-paypal" aria-hidden="true"></i> Donate PayPal](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=CLF223XAS4W72){: .btn .btn--primary} <br /> Discuss &nbsp; [<i class="fa fa-google" aria-hidden="true"></i> Google Group](https://groups.google.com/forum/?hl=en#!forum/diskover){: .btn .btn--primary}'
---
