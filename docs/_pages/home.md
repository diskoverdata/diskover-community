...
<div align="center">diskover-web hot dirs analytics screenshot (compare data to see hotspots on your storage)<br /><img src="https://github.com/shirosaidev/diskover-web/blob/master/docs/diskover-web-hotdirs-screenshot.png?raw=true" alt="diskover-web hotdirs" width="800" /></div>
