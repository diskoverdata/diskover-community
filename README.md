...
[diskover web tag manager](README-WEB.md) is a front-end for managing diskover's `tag` field, allowing you to search and tag files for deletion, archival or keeping.
