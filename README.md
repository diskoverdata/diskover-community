...
[diskover web tag manager](README-WEB.md) is a front-end of managing the diskover `tag` field, allowing you to search and tag files for deletion, archival or keeping.
