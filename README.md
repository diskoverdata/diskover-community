...
**diskover requires an auth token to run, learn more at https://github.com/shirosaidev/diskover/wiki/Auth-token and to sign up your account to receive your auth token at https://diskoverspace.com/diskover/**
